...
Основной код лежит в src/ и include/. Запускаемый и главный файл - main.cpp, в нем определена функция main в которой вызываем другие вспомогательные функции.
